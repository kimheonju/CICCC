...
class Maze():
    ...
    def solve(self):
        ...
        start = Node(state = self.start, parent = None, action = None, heuristic = manhattan_distance (self.start, self.goal))
        ...
        while True:
            ...
            for action, state in self.neighbors(node.state):            
                ...
                if not frontier.contains_state(state) and state not in self.explored:
                    ...
                    child = Node(state=state, parent=node, action=action, heuristic=manhattan_distance(state, self.goal))
                    frontier.add(child)                    
